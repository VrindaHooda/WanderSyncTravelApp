...
//        });
        ...
        binding.inviteUsers.setOnClickListener(v -> {
            Intent intent1 = new Intent(Logistics.this, AddUserActivity.class);
            startActivity(intent1);
        });

        binding.viewInvites.setOnClickListener(v -> {
            Intent intent2 = new Intent(Logistics.this, ViewInvitesActivity.class);
            startActivity(intent2);
        });

        binding.viewNotes.setOnClickListener(v -> {
            Intent intent3 = new Intent(Logistics.this, ViewNotesActivity.class);
